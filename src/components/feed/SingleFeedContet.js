...
const FeedForm = () => {
	...
	return (
		<form className="feed_content" style={{ alignItems: "center",paddingLeft:"5px" , width: "95%",marginTop:"30px" }} onSubmit={post}>
			<textarea
				type="text"
				id="content"
				
				style={{ border: "none", borderRadius: "10px", fontSize: "18px",width:"100%",height:"200px" }}
		...
		/>
			...
			<button className='feed_message_button'  type="submit">POST</button>
		</form>
	);
};
